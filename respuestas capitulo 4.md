...
## Preguntas y Ejercicios (Enunciados)
...
**4.1.** Supóngase que se transmiten datos mediante disquetes de 1,44 Mbyte con un peso de 30 g cada uno y que una compañía aérea transporta $10^4\text{ kg}$ de disquetes a una velocidad de 1.000 km/h sobre una distancia de 5.000 km. ¿Cuál es la velocidad de transmisión en bits por segundo de este sistema?

**4.2.** Sea una línea telefónica caracterizada por una pérdida de 20 dB. La potencia de la señal a la entrada es de 0,5 W y el nivel del ruido a la salida es de $4{,}5\ \mu\text{W}$. Calcule la relación señal-ruido para la línea en dB.
...
b) Ahora demuéstrese que $\tan \alpha = (p/y_1)$, lo que demostraría que $\alpha = \beta$. Sugerencia: recuérdese de trigonometría que la fórmula de la tangente de la diferencia entre dos ángulos $\alpha_1$ y $\alpha_2$ es $\tan(\alpha_2 - \alpha_1) = (\tan \alpha_2 - \tan \alpha_1) / (1 + \tan \alpha_2 \cdot \tan \alpha_1)$.
